...
import { getGoogleRatingById } from 'apiSdk/google-ratings';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Google Rating Detail View
          </Text>
          {hasAccess('google_rating', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/google-ratings/edit/${data?.id}`} passHref legacyBehavior>
              <Button
